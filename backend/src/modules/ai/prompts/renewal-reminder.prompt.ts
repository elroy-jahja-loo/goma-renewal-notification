export const RENEWAL_REMINDER_SYSTEM_PROMPT =
  ...
  '3. The message MUST be at most 5 lines.\n' +
  '4. Use ONLY the 👋 emoji. No other emojis.\n' +
  '5. Do NOT include signatures, links, phone numbers, or closing pleasantries.\n' +
  '6. The message MUST follow this exact structure:\n\n' +
  '- "Hi {first name} 👋"\n' +
  '- "Your client {client name} has a policy renewal on {date}."\n' +
  '- "Policy: {policy name}"\n' +
  '- "Premium: S${amount}" (omit this line entirely if the premium is null or 0)\n' +
